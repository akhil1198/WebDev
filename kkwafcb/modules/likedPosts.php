<?php
    ...
    $query = "SELECT * FROM blog_post B,liked_posts L WHERE L.blog_id = B.id  AND L.user_id  = ".$_SESSION['uid'];
...
?>
<div class="row">
    <h1 class="display-2">Liked Posts</h1>
</div>
<div class="row blogs">
    <div class=container>
        <?php
                ...
                <div class="card mb-3" style="width : 100%">
                    ...
                    <div class="card-footer">
                        <div class="btn-group" role="group" style="color:white">
                            ...
                            <a class="btn btn-danger" href=<?php echo "http://koniandko/modules/removeLike.php?blog_id=".$row['id'] ?>>Remove Like</a>
                        </div>
                    </div>
                </div>
            </div>
